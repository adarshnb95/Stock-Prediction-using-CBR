...
class BaseAttribute(object):
    ...
    def adjustable(self):
        ...
        (e.g. adjust price based on adjustment for stocks)"""
    ...
    @abstractproperty
    def sentiment_positive_score(self):
        """Weight for this attribute"""
        return self._sentiment_positive_score
...
class Attribute(BaseAttribute):
    ...
    @value.setter
    def sentiment_positive_score(self, sentiment_positive_score):
        if type(sentiment_positive_score) == type(self):
            self._sentiment_positive_score = sentiment_positive_score._sentiment_positive_score
        else:
            self._set_value(sentiment_positive_score)

    def _set_value(self, sentiment_positive_score):
        "Setter for value - to be overridden in subclasses"
        self._sentiment_positive_score = sentiment_positive_score


    ''' sentiment_negative_score '''
    @value.setter
    def sentiment_positive_score(self, sentiment_negative_score):
        if type(sentiment_negative_score) == type(self):
            self._sentiment_positive_score = sentiment_negative_score._sentiment_positive_score
        else:
            self._set_value(sentiment_negative_score)

    def _set_value(self, sentiment_negative_score):
        "Setter for value - to be overridden in subclasses"
        self._sentiment_positive_score = sentiment_negative_score
...
class Float(Attribute):
    """Attribute with positive numeric float values."""
